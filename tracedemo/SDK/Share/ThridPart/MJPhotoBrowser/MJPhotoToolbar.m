...
- (void)setPhotos:(NSArray *)photos
{
    ...
    [_saveImageBtn setImage:[UIImage imageNamed:@"saveOver.png"] forState:UIControlStateNormal];
    [_saveImageBtn setImage:[UIImage imageNamed:@"saveButton.png"] forState:UIControlStateHighlighted];
